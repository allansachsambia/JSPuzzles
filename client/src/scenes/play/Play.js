      ...
      default:
        return (
          <div className="play-as-guest">
            <Nav for="play" />
            <Top />
            <Popup userType="guest" />
            <div className="play-controls">
              <div className="control">
                <Link to={"/"}>
                  <i
                    className="controls-icon cheat-icon fa fa-home"
                    aria-hidden="true"
                  />
                </Link>
              </div>
              <div
                className="control"
                onKeyDown={this.displayPopup}
                onClick={this.displayPopup}
              >
                <i
                  className="controls-icon cheat-icon fa fa-flag-o"
                  aria-hidden="true"
                />
              </div>
              <div
              ...
              >
                <i
                  className="controls-icon forward-icon fa fa-arrow-circle-o-right"
                  aria-hidden="true"
                />
              </div>
            </div>
