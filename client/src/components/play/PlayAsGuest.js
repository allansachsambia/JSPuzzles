...
import PlayAsGuestStyles from './../../styles/play/play-as-guest.css';

export class PlayAsGuest extends Component {
  constructor(props) {
    super(props);
  ...
  componentWillMount() {
    const firstIndex = this.props.current || 0;
    this.props.setCode(this.props.questions[firstIndex].code);
    this.props.setAnswers(this.props.questions);
    this.props.setCurrent(firstIndex);
  }
  ...
  setAnswers() {
    ...
    const newAnswers = answers[0].map((answer, i) => {
      if (i === this.props.current) {
        return { name: answer.name, code: this.props.code };
      }
      return answer;
    }, this);
  ...
  render() {
    ...
    switch (this.props.current) {
      ...
      default:
        return (
          <div className="play-as-guest">
            <Nav for="play" />
            <PlayHeader />
            <PlayCheatModal userType="guest" />
            <div className="play-controls">
              <div role="button" tabIndex={0} className="control">
                <Link to="/dashboard">
                  <i
                    className="controls-icon dashboard-icon fa fa-tachometer"
                    aria-hidden="true"
                  />
                </Link>
              </div>
              ...
              >
                <i
                  className="controls-icon eraser-icon fa fa-eraser"
                  aria-hidden="true"
                />
              </div>
              <div
              ...
              >
                <i
                  className="controls-icon forward-icon fa fa-forward"
                  aria-hidden="true"
                />
              </div>
            </div>
